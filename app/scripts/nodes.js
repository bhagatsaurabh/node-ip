...
ImageSourceNode.prototype.checkBounds = function (x, y) {
  if (
    x > this.node.x - this.node.width / 2 - globalTerminalRadius / 2 &&
    x < this.node.x + this.node.width / 2 + globalTerminalRadius / 2 &&
...
var GrayscaleNode = function (x, y, width, order, hPadding, vSpacing) {
  ...
  var newChoiceGroup = new ChoiceGroup(["Average", "Weighted"], 0, (choice) => {
    ...
    checkConnectionToOutput(this.node, nodes);
  });
...
var LayerNode = function (x, y, width, order, hPadding, vSpacing) {
  ...
  var hozLayout1 = new HorizontalLayout(globalBaseHeight, [slider1, label1], 5, [0.7, 0.3]);
  ...
  var hozLayout2 = new HorizontalLayout(globalBaseHeight, [slider2, label2], 5, [0.7, 0.3]);
  ...
  var newButton = new Button(globalBaseHeight * 0.85, "Add", () => {
    ...
    var hozLayout = new HorizontalLayout(globalBaseHeight, [slider, label], 5, [0.7, 0.3]);
...
var BrightnessNode = function (x, y, width, order, hPadding, vSpacing) {
  ...
  var inTerminal = new Terminal(
    "in",
    "image|channelR|channelG|channelB",
